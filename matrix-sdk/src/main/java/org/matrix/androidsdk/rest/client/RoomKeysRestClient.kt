...
class RoomKeysRestClient(hsConfig: HomeServerConnectionConfig) :
        RestClient<RoomKeysApi>(hsConfig, RoomKeysApi::class.java, RestClient.URI_API_PREFIX_PATH_R0, false) {

    /**
     * Get key backup version
     * If not supported by the server, an error is returned: {"errcode":"M_UNRECOGNIZED","error":"Unrecognized request"}
     * Should return {"errcode":"M_NOT_FOUND","error":"No backup found"}
     *
     * @param version  version or null to get the current version
